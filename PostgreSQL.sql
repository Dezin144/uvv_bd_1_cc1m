create role andre with superuser inherit createdb createrole password 'computacao@raiz'; 
...
COMMENT ON TABLE funcionario IS 'Tabela "funcionario" contém o cpf, nome, data de nascimento, endereço, sexo, salário, cpf do supervisor que nesse caso também está na tabela funcionário, além do número do departamento em que ele trabalha.';
...
COMMENT ON TABLE departamento IS 'Tabela "departamento" contém o número e o nome dele, cpf do gerente, data que começou o gerente.';
...
COMMENT ON TABLE projeto IS 'Tabela "projeto" nele tem as informações, como o número, nome, local do projeto, além do departamento responsável por ele.';
...
COMMENT ON TABLE dependente IS 'Tabela "dependente" mostra os dependentes interligados a cada funcionário. As propriedades da tabela são cpf do funcionário, nome, sexo, data de nascimento e parentesco dos dependentes.';
